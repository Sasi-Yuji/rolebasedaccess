...
<head>
    ...
    <title>Forgot Password | CampusPro ERP</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-card { width: 100%; max-width: 440px; padding: 2.5rem; background: white; border-radius: 24px; shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); }
        ...
        .btn-submit { width: 100%; padding: 0.9rem; background: var(--primary); color: white; border: none; border-radius: 12px; font-weight: 600; cursor: pointer; margin-top: 1rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem; text-decoration: none; }
        ...
        .back-to-login { display: block; text-align: center; margin-top: 1.5rem; color: var(--secondary); text-decoration: none; font-size: 0.85rem; font-weight: 500; }
...
<body>
    <div class="auth-card">
        ...
        <p class="subtitle">Enter your email address to receive a 6-digit verification OTP.</p>
        ...
        <form action="<?= base_url('forgot-password') ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="yourname@college.edu" required autofocus>
                </div>
            </div>
            <button type="submit" class="btn-submit">Send OTP <i class="fas fa-paper-plane"></i></button>
        </form>
        <a href="<?= base_url('login') ?>" class="back-to-login"><i class="fas fa-arrow-left"></i> Back to Login</a>
    </div>
</body>
</html>
