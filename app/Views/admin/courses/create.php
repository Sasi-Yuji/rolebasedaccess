<div class="glass-card" style="padding: 1.5rem; margin-top: 1rem; max-width: 800px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <h2 style="font-size: 1.25rem; font-weight: 600;">Add New Course</h2>
    ...
    <form action="<?= base_url('admin/courses/store') ?>" method="POST" id="createCourseForm">
        <?= csrf_field() ?>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                ...
                <select name="course_name" id="course_name" required onchange="populateCourseCode()"
                    style="padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 1rem;" 
                    class="focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" disabled>
                    <option value="">Select Department First</option>
                </select>
                <!-- Fallback hidden input to restore old value on error -->
            ...
            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                ...
                <input type="text" name="course_code" id="course_code" value="<?= old('course_code') ?>" placeholder="Auto-filled" required readonly 
            ...
            <!-- Status -->
            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                <label for="status" style="font-weight: 500; font-size: 0.875rem; color: #475569;">Initial Status <span style="color: #ef4444;">*</span></label>
        ...
        <div style="margin-top: 2rem; display: flex; justify-content: flex-end;">
            <button type="submit" class="btn btn-primary" style="padding: 0.75rem 2rem; font-weight: 600;">
                <i class="fas fa-save" style="margin-right: 0.5rem;"></i> Save Course
            </button>
        </div>
    </form>
</div>
